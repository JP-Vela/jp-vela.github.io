...
<head>
  ...
  <!--NavBar-->
    <nav class="navbar navbar-expand-lg navbar-dark black" style="position:fixed; top:0; left:0; width:100%;">
        <a class="navbar-brand" href="#">JohnPaul Vela</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-light" href="myWork.html">My Work</a>
                </li>
                <li class="nav-item">
